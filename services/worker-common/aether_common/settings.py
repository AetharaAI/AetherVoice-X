...
class Settings(BaseSettings):
    ...
    default_stream_tts_model: str = Field(default="kokoro_realtime", validation_alias=AliasChoices("DEFAULT_STREAM_TTS_MODEL"))
    ...
    kokoro_model_path: str | None = Field(default=None, validation_alias=AliasChoices("KOKORO_MODEL_PATH"))
    kokoro_default_voice: str = Field(default="af_sky", validation_alias=AliasChoices("KOKORO_DEFAULT_VOICE"))
    kokoro_realtime_base_url: str | None = Field(default=None, validation_alias=AliasChoices("KOKORO_REALTIME_BASE_URL", "KOKORO_BASE_URL"))
    kokoro_realtime_timeout_seconds: float = Field(default=120.0, validation_alias=AliasChoices("KOKORO_REALTIME_TIMEOUT_SECONDS"))
    ...
    moss_tts_model_id: str = Field(default="OpenMOSS-Team/MOSS-TTS", validation_alias=AliasChoices("MOSS_TTS_MODEL_ID"))
    moss_tts_base_url: str | None = Field(default=None, validation_alias=AliasChoices("MOSS_TTS_BASE_URL"))
    moss_tts_timeout_seconds: float = Field(default=240.0, validation_alias=AliasChoices("MOSS_TTS_TIMEOUT_SECONDS"))
    moss_tts_model_path: str | None = Field(default=None, validation_alias=AliasChoices("MOSS_TTS_MODEL_PATH"))
    moss_ttsd_model_id: str = Field(default="OpenMOSS-Team/MOSS-TTSD-v1.0", validation_alias=AliasChoices("MOSS_TTSD_MODEL_ID"))
    moss_ttsd_base_url: str | None = Field(default=None, validation_alias=AliasChoices("MOSS_TTSD_BASE_URL"))
    moss_ttsd_timeout_seconds: float = Field(default=240.0, validation_alias=AliasChoices("MOSS_TTSD_TIMEOUT_SECONDS"))
    moss_ttsd_model_path: str | None = Field(default=None, validation_alias=AliasChoices("MOSS_TTSD_MODEL_PATH"))
    moss_voice_generator_model_id: str = Field(default="OpenMOSS-Team/MOSS-VoiceGenerator", validation_alias=AliasChoices("MOSS_VOICE_GENERATOR_MODEL_ID"))
    moss_voice_generator_base_url: str | None = Field(default=None, validation_alias=AliasChoices("MOSS_VOICE_GENERATOR_BASE_URL"))
    moss_voice_generator_timeout_seconds: float = Field(default=240.0, validation_alias=AliasChoices("MOSS_VOICE_GENERATOR_TIMEOUT_SECONDS"))
    moss_voice_generator_model_path: str | None = Field(default=None, validation_alias=AliasChoices("MOSS_VOICE_GENERATOR_MODEL_PATH"))
    moss_soundeffect_model_id: str = Field(default="OpenMOSS-Team/MOSS-SoundEffect", validation_alias=AliasChoices("MOSS_SOUNDEFFECT_MODEL_ID", "MOSS_SOUND_EFFECT_MODEL_ID"))
    moss_soundeffect_base_url: str | None = Field(default=None, validation_alias=AliasChoices("MOSS_SOUNDEFFECT_BASE_URL", "MOSS_SOUND_EFFECT_BASE_URL"))
    moss_soundeffect_timeout_seconds: float = Field(default=240.0, validation_alias=AliasChoices("MOSS_SOUNDEFFECT_TIMEOUT_SECONDS", "MOSS_SOUND_EFFECT_TIMEOUT_SECONDS"))
    moss_soundeffect_model_path: str | None = Field(default=None, validation_alias=AliasChoices("MOSS_SOUNDEFFECT_MODEL_PATH", "MOSS_SOUND_EFFECT_MODEL_PATH"))
    ...
    studio_openrouter_base_url: str | None = Field(default="https://openrouter.ai/api/v1", validation_alias=AliasChoices("STUDIO_OPENROUTER_BASE_URL"))
    studio_openrouter_api_key: str | None = Field(default=None, validation_alias=AliasChoices("STUDIO_OPENROUTER_API_KEY", "OPENROUTER_API_KEY"))
    studio_litellm_base_url: str | None = Field(default=None, validation_alias=AliasChoices("STUDIO_LITELLM_BASE_URL", "LITELLM_BASE_URL"))
    studio_litellm_api_key: str | None = Field(default=None, validation_alias=AliasChoices("STUDIO_LITELLM_API_KEY", "LITELLM_API_KEY"))
    studio_litellm_auth_header: str | None = Field(default="Authorization", validation_alias=AliasChoices("STUDIO_LITELLM_AUTH_HEADER"))
