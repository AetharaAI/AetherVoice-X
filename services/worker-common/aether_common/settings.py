...
class Settings(BaseSettings):
    ...
    voxtral_stream_clear_after_commit: bool = Field(default=True, validation_alias=AliasChoices("VOXTRAL_STREAM_CLEAR_AFTER_COMMIT"))
    ...
    qwen_provider_voice_design_model_alias: str = Field(default="qwen_voice_design", validation_alias=AliasChoices("QWEN_PROVIDER_VOICE_DESIGN_MODEL_ALIAS"))
    ...
    voxtream_model_id: str = Field(default="herimor/voxtream", validation_alias=AliasChoices("VOXTREAM_MODEL_ID"))
    voxtream_model_path: str | None = Field(default=None, validation_alias=AliasChoices("VOXTREAM_MODEL_PATH"))
    voxtream_realtime_base_url: str | None = Field(default=None, validation_alias=AliasChoices("VOXTREAM_REALTIME_BASE_URL", "VOXTREAM_BASE_URL"))
    voxtream_realtime_timeout_seconds: float = Field(default=120.0, validation_alias=AliasChoices("VOXTREAM_REALTIME_TIMEOUT_SECONDS"))
    voxtream2_model_id: str = Field(default="herimor/voxtream2", validation_alias=AliasChoices("VOXTREAM2_MODEL_ID"))
    voxtream2_model_path: str | None = Field(default=None, validation_alias=AliasChoices("VOXTREAM2_MODEL_PATH"))
    voxtream2_realtime_base_url: str | None = Field(default=None, validation_alias=AliasChoices("VOXTREAM2_REALTIME_BASE_URL", "VOXTREAM2_BASE_URL"))
    voxtream2_realtime_timeout_seconds: float = Field(default=120.0, validation_alias=AliasChoices("VOXTREAM2_REALTIME_TIMEOUT_SECONDS"))
    voxtral_tts_base_url: str | None = Field(default=None, validation_alias=AliasChoices("VOXTRAL_TTS_BASE_URL"))
    voxtral_tts_timeout_seconds: float = Field(default=180.0, validation_alias=AliasChoices("VOXTRAL_TTS_TIMEOUT_SECONDS"))
    voxtral_tts_model_alias: str = Field(default="/mnt/aetherpro/models/audio/mistralai/Voxtral-4B-TTS-2603", validation_alias=AliasChoices("VOXTRAL_TTS_MODEL_ALIAS"))
    voxtral_tts_default_voice: str = Field(default="casual_female", validation_alias=AliasChoices("VOXTRAL_TTS_DEFAULT_VOICE"))
