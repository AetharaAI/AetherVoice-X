...
def _build_runtime() -> RuntimeAssets:
    ...
    return RuntimeAssets(
        ...
        temperature=_env_float("MOSS_REALTIME_TEMPERATURE", 0.45),
        top_p=_env_float("MOSS_REALTIME_TOP_P", 0.65),
        ...
        prefill_text_len=_env_int("MOSS_REALTIME_PREFILL_TEXT_LEN", 24),
        decode_chunk_frames=_env_int("MOSS_REALTIME_DECODE_CHUNK_FRAMES", 6),
