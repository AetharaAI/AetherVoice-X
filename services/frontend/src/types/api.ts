...
export interface StudioVoice {
  ...
  source_model: string;
  runtime_target: "kokoro_realtime" | "chatterbox" | "qwen_customvoice" | "qwen_customvoice_streaming" | "qwen_voice_design";
...
export interface StudioRouteDescriptor {
  name: "kokoro_realtime" | "chatterbox" | "qwen_customvoice" | "qwen_customvoice_streaming" | "qwen_voice_design";
  label: string;
