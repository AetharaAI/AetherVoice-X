...
Next, you should install vllm-omni from "main".

uv pip install git+https://github.com/vllm-project/vllm-omni.git --upgrade

    If you do are seeing an error due to git not being installed, make sure to run apt update;apt install -y git and try again.
